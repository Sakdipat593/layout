      ...
      <div className="menu">
        {menuItems.map((item, index) => (
          <div key={index} className="menu-item">
            ...
            <Link href={item.href} className="custom-link">
              {item.name}
            </Link>
          </div>
        ))}
